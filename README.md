...
Once installed, navigate to your development project directory and use the following commands:
...
*   **Memory Management (`memory`):**
    Manage project learnings, conventions, or architecture decisions locally or globally:
    ```bash
...
#### 2. Các lệnh quản lý chính
Sau khi cài đặt, di chuyển đến thư mục dự án phát triển của bạn và sử dụng các lệnh sau:
